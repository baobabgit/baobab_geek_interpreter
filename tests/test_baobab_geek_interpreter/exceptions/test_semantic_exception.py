"""Tests unitaires pour la classe BaobabSemanticAnalyserException."""
...
class TestBaobabSemanticAnalyserException:
    """Classe de tests pour BaobabSemanticAnalyserException."""

    def test_inherits_from_base_exception(self) -> None:
        """Test que la classe hérite de BaobabGeekInterpreterException."""
        exception = BaobabSemanticAnalyserException("Test error")
    ...
    def test_init_with_message_only(self) -> None:
        ...
        exception = BaobabSemanticAnalyserException(message)
    ...
    def test_init_with_all_parameters(self) -> None:
        ...
        exception = BaobabSemanticAnalyserException(
    ...
    def test_can_be_raised_and_caught(self) -> None:
        ...
        with pytest.raises(BaobabSemanticAnalyserException) as exc_info:
            raise BaobabSemanticAnalyserException("Semantic error")

        assert exc_info.value.message == "Semantic error"
    ...
    def test_can_be_caught_as_base_exception(self) -> None:
        ...
        try:
            raise BaobabSemanticAnalyserException("Test")
        except BaobabGeekInterpreterException as e:
            assert isinstance(e, BaobabSemanticAnalyserException)
            assert str(e) == "Test"

    def test_str_representation(self) -> None:
        """Test la représentation en chaîne."""
        exception = BaobabSemanticAnalyserException("Type mismatch", line=2, column=15)

        assert str(exception) == "Type mismatch at line 2, column 15"
